...
_FALLBACK = {"json", "csv", "math", "os", "re", "sys", "argparse", "dataclasses", "typing",
             "datetime", "glob", "ast", "pathlib", "subprocess", "hashlib", "io",
             "collections", "itertools", "functools", "unittest", "tempfile"}
